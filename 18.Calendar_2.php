...
<head>
    ...
    <style type="text/css">
        * {
        ...
        .left_part .calendar_table .cell5 td {
            padding: 6px 0;
        }
        .left_part .calendar_table .cell5 tr.first td {
            padding: 0;
        }
        .left_part .calendar_table .cell5 tr.second td {
            padding: 0 0 6px 0;
        }
        .left_part .calendar_table .cell5 tr.last td {
            padding: 7px 0;
        }
        .red
        {
...
<div class="calendar"> <!-- 日历主体 -->
    <div class="left_part"> <!-- 左部 -->
        ...
        <div class="calendar_table"> <!-- 左边部分的下部 -->
            <table cellspacing="0" cellpadding="0" <?php if ($rear_day>=7) echo "class='cell5'" ?>>
                <tr class="first">
                    <td><span>一</span></td>
                    <td><span>二</span></td>
                    <td><span>三</span></td>
