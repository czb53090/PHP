...
window.onload = function() {
    ...
    for (var i = 0; i != folder_lis_len; i++)
    {
        ...
        dotss[i].onclick = function() {
            ...
            // 按下 删除 按钮
            operations[this.index][2].index = this.index;
            operations[this.index][2].onclick = function() {
                // alert("按下 删除 按钮");
                // alert(folders[this.index].children[0].innerHTML);
                delete_box.style.display = "block";
                cover.style.display = "block";
                var i = form_del.action.indexOf("del=");
                form_del.action = form_del.action.substring(0, i) +
                    "del=" + folders[this.index].children[0].innerHTML; // 获选选中的文件夹的名称
            }
        }
        ...
        rename.onclick = function() {
            ...
            // alert(folders[this.index].children[0].innerHTML);
            text_rn.value = folders[this.index-1].children[0].innerHTML;
            // alert(this.index); // OK
            ...
            hidden_rn.value += "&old_name=" + folders[this.index-1].children[0].innerHTML + "";
    ...
    close_del.onclick = btn_cancel_del.onclick = function() {
        ...
        var i = form_del.action.indexOf("del=");
        form_del.action = form_del.action.substring(0, i-1 );
    }
